(function (global, factory) {
     ...
     */
    var AudioBarService = /** @class */ (function () {
        function AudioBarService() {
        }
        ...
        /** @nocollapse */
        AudioBarService.ctorParameters = function () { return []; };
    ...
    var AudioBarComponent = /** @class */ (function () {
        ...
        AudioBarComponent.propDecorators = {
            recording: [{ type: i0.Input }],
            recorded: [{ type: i0.Input }],
            playing: [{ type: i0.Input }]
        };
    ...
    exports.AudioBarService = AudioBarService;
